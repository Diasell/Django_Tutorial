...
class JournalView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        # calculate current, prev and next month details;
        ...
        # prepare variable for template to generate journal table
        # header elements
        ...
        context['month_header'] = [
            {'day': d,
             'verbose': day_abbr[weekday(myear,mmonth, d)][:2]} for d in range(1, number_of_days+1)]
        ...
        # go over all studnets and collect data about presence
    ...
    def post(self, request, *args, **kwargs):
        ...
        #prepate student, dates and presence data
        ...
        # set new presence  on journal for given student and save the result
